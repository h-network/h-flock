...
| A destructive pop is never retried automatically after an ambiguous Redis failure. | One router step removes two envelopes, or a single envelope is forwarded twice, after one connection interruption. |
